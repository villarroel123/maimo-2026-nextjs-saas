...
const CONFIRMED_FANPROJECT_STATUSES = new Set(["en_preparacion", "listo"]);
...
export function isFanProjectVotable(value) {
  return getFanProjectStatus(value).value === "planificado";
}

export function isFanProjectConfirmed(value) {
  return CONFIRMED_FANPROJECT_STATUSES.has(getFanProjectStatus(value).value);
}
